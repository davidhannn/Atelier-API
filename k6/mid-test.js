...
// Randomized Single Product for middle rows%
// export default function() {
//   let randomInt = 500000 + Math.floor(Math.random() * 100000)
...
// Randomized Product Styles for middle rows
// export default function() {
//   let randomInt = 500000 + Math.floor(Math.random() * 100000)
...
// Randomized Related Items for middle rows
export default function() {
  let randomInt = 500000 + Math.floor(Math.random() * 100000)
